...
Spectator.describe Proton::MTProto::GzipPacked do
  context ".decompress" do
    it "decompresses gzipped data" do
      rpc_result = Bytes[
      ...
      rpc_result = Proton::MTProto::RpcResult.from_bytes(rpc_result)
      gzip = Proton::MTProto::GzipPacked.from_bytes(rpc_result.result)

      expect(gzip.decompress.size).to eq(984)
    end
  end
end
