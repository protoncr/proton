...
module Proton::ClientMethods
  ...
  def accept_call(call_id : ::Int32, protocol : Proton::Types::CallProtocol)
    broadcast(Types::Ok,
      {"@type"    => "acceptCall",
       "call_id"  => call_id,
       "protocol" => protocol
  ...
  def accept_terms_of_service(terms_of_service_id : ::String)
    broadcast(Types::Ok,
  ...
  def add_chat_member(chat_id : ::Int64, user_id : ::Int32, forward_limit : ::Int32)
    broadcast(Types::Ok,
      {"@type"         => "addChatMember",
       "chat_id"       => chat_id,
       "user_id"       => user_id,
  ...
  def add_chat_members(chat_id : ::Int64, user_ids : ::Array(::Int32))
    broadcast(Types::Ok,
      {"@type"    => "addChatMembers",
       "chat_id"  => chat_id,
       "user_ids" => user_ids
  ...
  def add_custom_server_language_pack(language_pack_id : ::String)
    broadcast(Types::Ok,
  ...
  def add_favorite_sticker(sticker : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def add_local_message(chat_id : ::Int64, sender_user_id : ::Int32, reply_to_message_id : ::Int64, disable_notification : ::Bool, input_message_content : Proton::Types::InputMessageContent)
  ...
  def add_log_message(verbosity_level : ::Int32, text : ::String)
    broadcast(Types::Ok,
      {"@type"           => "addLogMessage",
  ...
  def add_network_statistics(entry : Proton::Types::NetworkStatisticsEntry)
    broadcast(Types::Ok,
  ...
  def add_proxy(server : ::String, port : ::Int32, enable : ::Bool, type : Proton::Types::ProxyType)
    broadcast(Types::Proxy,
      {"@type"  => "addProxy",
       "server" => server,
       "port"   => port,
       "enable" => enable,
  ...
  # sticker [Proton::Types::InputFile] Sticker file to add.
  def add_recent_sticker(is_attached : ::Bool, sticker : Proton::Types::InputFile)
    broadcast(Types::Stickers,
  ...
  def add_recently_found_chat(chat_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def add_saved_animation(animation : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def add_sticker_to_set(user_id : ::Int32, name : ::String, sticker : Proton::Types::InputSticker)
    broadcast(Types::StickerSet,
  ...
  def answer_callback_query(callback_query_id : ::String, text : ::String, show_alert : ::Bool, url : ::String, cache_time : ::Int32)
    broadcast(Types::Ok,
  ...
  def answer_custom_query(custom_query_id : ::String, data : ::String)
    broadcast(Types::Ok,
  ...
  def answer_inline_query(inline_query_id : ::String, is_personal : ::Bool, results : ::Array(Proton::Types::InputInlineQueryResult), cache_time : ::Int32, next_offset : ::String, switch_pm_text : ::String, switch_pm_parameter : ::String)
    broadcast(Types::Ok,
  ...
  def answer_pre_checkout_query(pre_checkout_query_id : ::String, error_message : ::String)
    broadcast(Types::Ok,
  ...
  # error_message [::String] An error message, empty on success.
  def answer_shipping_query(shipping_query_id : ::String, shipping_options : ::Array(Proton::Types::ShippingOption), error_message : ::String)
    broadcast(Types::Ok,
  ...
  def cancel_download_file(file_id : ::Int32, only_if_pending : ::Bool)
    broadcast(Types::Ok,
  ...
  def cancel_upload_file(file_id : ::Int32)
    broadcast(Types::Ok,
  ...
  def change_chat_report_spam_state(chat_id : ::Int64, is_spam_chat : ::Bool)
    broadcast(Types::Ok,
  ...
  #   imported.
  def change_imported_contacts(contacts : ::Array(Proton::Types::Contact))
    broadcast(Types::ImportedContacts,
  ...
  #   number.
  def change_phone_number(phone_number : ::String, settings : Proton::Types::PhoneNumberAuthenticationSettings)
    broadcast(Types::AuthenticationCodeInfo,
  ...
  def change_sticker_set(set_id : ::String, is_installed : ::Bool, is_archived : ::Bool)
    broadcast(Types::Ok,
  ...
  def check_authentication_bot_token(token : ::String)
    broadcast(Types::Ok,
  ...
  def check_authentication_code(code : ::String)
    broadcast(Types::Ok,
  ...
  def check_authentication_password(password : ::String)
    broadcast(Types::Ok,
  ...
  def check_change_phone_number_code(code : ::String)
    broadcast(Types::Ok,
  ...
  def check_chat_invite_link(invite_link : ::String)
    broadcast(Types::ChatInviteLinkInfo,
  ...
  def check_chat_username(chat_id : ::Int64, username : ::String)
    broadcast(Types::CheckChatUsernameResult,
  ...
  def check_database_encryption_key(encryption_key : ::String)
    broadcast(Types::Ok,
  ...
  def check_email_address_verification_code(code : ::String)
    broadcast(Types::Ok,
  ...
  def check_phone_number_confirmation_code(code : ::String)
    broadcast(Types::Ok,
  ...
  # code [::String] Verification code.
  def check_phone_number_verification_code(code : ::String)
    broadcast(Types::Ok,
  ...
  # code [::String] Verification code.
  def check_recovery_email_address_code(code : ::String)
    broadcast(Types::PasswordState,
  ...
  def clean_file_name(file_name : ::String)
    broadcast(Types::Text,
      {"@type"     => "cleanFileName",
       "file_name" => file_name
      })
  end
  ...
  def clear_all_draft_messages(exclude_secret_chats : ::Bool)
    broadcast(Types::Ok,
  ...
  def clear_recent_stickers(is_attached : ::Bool)
    broadcast(Types::Ok,
  ...
  def close_secret_chat(secret_chat_id : ::Int32)
    broadcast(Types::Ok,
  ...
  def create_basic_group_chat(basic_group_id : ::Int32, force : ::Bool)
  ...
  # protocol [Proton::Types::CallProtocol] Description of the call protocols supported by the client.
  def create_call(user_id : ::Int32, protocol : Proton::Types::CallProtocol)
    broadcast(Types::CallId,
      {"@type"    => "createCall",
       "user_id"  => user_id,
       "protocol" => protocol
      })
  ...
  def create_new_basic_group_chat(user_ids : ::Array(::Int32), title : ::String)
    broadcast(Types::Chat,
  ...
  def create_new_secret_chat(user_id : ::Int32)
    broadcast(Types::Chat,
  ...
  def create_new_sticker_set(user_id : ::Int32, title : ::String, name : ::String, is_masks : ::Bool, stickers : ::Array(Proton::Types::InputSticker))
    broadcast(Types::StickerSet,
  ...
  def create_new_supergroup_chat(title : ::String, is_channel : ::Bool, description : ::String)
    broadcast(Types::Chat,
  ...
  # force [::Bool] If true, the chat will be created without network request.
  #   In this case all information about the chat except its type, title and photo can be incorrect.
  def create_private_chat(user_id : ::Int32, force : ::Bool)
    broadcast(Types::Chat,
  ...
  # secret_chat_id [::Int32] Secret chat identifier.
  def create_secret_chat(secret_chat_id : ::Int32)
    broadcast(Types::Chat,
  ...
  # force [::Bool] If true, the chat will be created without network request.
  #   In this case all information about the chat except its type, title and photo can be incorrect.
  def create_supergroup_chat(supergroup_id : ::Int32, force : ::Bool)
    broadcast(Types::Chat,
  ...
  #   86400.
  def create_temporary_password(password : ::String, valid_for : ::Int32)
    broadcast(Types::TemporaryPasswordState,
  ...
  def delete_account(reason : ::String? = nil)
    broadcast(Types::Ok,
      {"@type"  => "deleteAccount",
       "reason" => reason
      })
  ...
  def delete_chat_history(chat_id : ::Int64, remove_from_chat_list : ::Bool, revoke : ::Bool)
    broadcast(Types::Ok,
  ...
  # chat_id [::Int64] Chat identifier.
  # user_id [::Int32] User identifier.
  def delete_chat_messages_from_user(chat_id : ::Int64, user_id : ::Int32)
    broadcast(Types::Ok,
  ...
  def delete_chat_reply_markup(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def delete_language_pack(language_pack_id : ::String)
    broadcast(Types::Ok,
  ...
  def delete_messages(chat_id : ::Int64, message_ids : ::Array(::Int64), revoke : ::Bool)
    broadcast(Types::Ok,
      {"@type"       => "deleteMessages",
       "chat_id"     => chat_id,
  ...
  def delete_passport_element(type : Proton::Types::PassportElementType)
    broadcast(Types::Ok,
  ...
  def delete_profile_photo(profile_photo_id : ::String)
    broadcast(Types::Ok,
  ...
  def delete_supergroup(supergroup_id : ::Int32)
    broadcast(Types::Ok,
  ...
  def discard_call(call_id : ::Int32, is_disconnected : ::Bool, duration : ::Int32, connection_id : ::String)
    broadcast(Types::Ok,
      {"@type"           => "discardCall",
       "call_id"         => call_id,
  ...
  def disconnect_website(website_id : ::String)
    broadcast(Types::Ok,
  ...
  def download_file(file_id : ::Int32, priority : ::Int32, offset : ::Int32, limit : ::Int32, synchronous : ::Bool)
    broadcast(Types::File,
      {"@type"       => "downloadFile",
       "file_id"     => file_id,
       "priority"    => priority,
       "offset"      => offset,
  ...
  def edit_custom_language_pack_info(info : Proton::Types::LanguagePackInfo)
    broadcast(Types::Ok,
  ...
  #   characters.
  def edit_inline_message_caption(inline_message_id : ::String, reply_markup : Proton::Types::ReplyMarkup, caption : Proton::Types::FormattedText)
    broadcast(Types::Ok,
  ...
  def edit_inline_message_live_location(inline_message_id : ::String, reply_markup : Proton::Types::ReplyMarkup, location : Proton::Types::Location? = nil)
    broadcast(Types::Ok,
  ...
  # reply_markup [Proton::Types::ReplyMarkup, nil] The new message reply markup; for bots only.
  def edit_inline_message_media(inline_message_id : ::String, input_message_content : Proton::Types::InputMessageContent, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Ok,
  ...
  # inline_message_id [::String] Inline message identifier.
  # reply_markup [Proton::Types::ReplyMarkup] The new message reply markup.
  def edit_inline_message_reply_markup(inline_message_id : ::String, reply_markup : Proton::Types::ReplyMarkup)
    broadcast(Types::Ok,
  ...
  def edit_inline_message_text(inline_message_id : ::String, reply_markup : Proton::Types::ReplyMarkup, input_message_content : Proton::Types::InputMessageContent)
    broadcast(Types::Ok,
  ...
  #   characters.
  # reply_markup [Proton::Types::ReplyMarkup, nil] The new message reply markup; for bots only.
  def edit_message_caption(chat_id : ::Int64, message_id : ::Int64, caption : Proton::Types::FormattedText, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Message,
  ...
  # location [Proton::Types::Location, nil] New location content of the message; may be null.
  #   Pass null to stop sharing the live location.
  def edit_message_live_location(chat_id : ::Int64, message_id : ::Int64, reply_markup : Proton::Types::ReplyMarkup? = nil, location : Proton::Types::Location? = nil)
    broadcast(Types::Message,
  ...
  #   InputMessagePhoto or InputMessageVideo.
  # reply_markup [Proton::Types::ReplyMarkup, nil] The new message reply markup; for bots only.
  def edit_message_media(chat_id : ::Int64, message_id : ::Int64, input_message_content : Proton::Types::InputMessageContent, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Message,
  ...
  # message_id [::Int64] Identifier of the message.
  # reply_markup [Proton::Types::ReplyMarkup] The new message reply markup.
  def edit_message_reply_markup(chat_id : ::Int64, message_id : ::Int64, reply_markup : Proton::Types::ReplyMarkup)
    broadcast(Types::Message,
  ...
  #   Should be of type InputMessageText.
  # reply_markup [Proton::Types::ReplyMarkup, nil] The new message reply markup; for bots only.
  def edit_message_text(chat_id : ::Int64, message_id : ::Int64, input_message_content : Proton::Types::InputMessageContent, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Message,
  ...
  # enable [::Bool] True, if the proxy should be enabled.
  # type [Proton::Types::ProxyType] Proxy type.
  def edit_proxy(proxy_id : ::Int32, server : ::String, port : ::Int32, enable : ::Bool, type : Proton::Types::ProxyType)
    broadcast(Types::Proxy,
      {"@type"    => "editProxy",
       "proxy_id" => proxy_id,
       "server"   => server,
  ...
  # Can be called before authorization.
  # proxy_id [::Int32] Proxy identifier.
  def enable_proxy(proxy_id : ::Int32)
    broadcast(Types::Ok,
      {"@type"    => "enableProxy",
       "proxy_id" => proxy_id
      })
  ...
  def finish_file_generation(generation_id : ::String, error : Proton::Types::Error)
    broadcast(Types::Ok,
  ...
  def forward_messages(chat_id : ::Int64, from_chat_id : ::Int64, message_ids : ::Array(::Int64), disable_notification : ::Bool, from_background : ::Bool, as_album : ::Bool, send_copy : ::Bool, remove_caption : ::Bool)
    broadcast(Types::Messages,
  ...
  # chat_id [::Int64] Chat identifier.
  def generate_chat_invite_link(chat_id : ::Int64)
    broadcast(Types::ChatInviteLink,
  ...
  def get_all_passport_elements(password : ::String)
    broadcast(Types::PassportElements,
  ...
  def get_archived_sticker_sets(is_masks : ::Bool, offset_sticker_set_id : ::String, limit : ::Int32)
    broadcast(Types::StickerSets,
  ...
  def get_attached_sticker_sets(file_id : ::Int32)
    broadcast(Types::StickerSets,
  ...
  def get_authorization_state()
    broadcast(Types::AuthorizationState,
  ...
  def get_auto_download_settings_presets()
    broadcast(Types::AutoDownloadSettingsPresets,
  ...
  def get_background_url(name : ::String, type : Proton::Types::BackgroundType)
    broadcast(Types::HttpUrl,
  ...
  def get_backgrounds(for_dark_theme : ::Bool)
    broadcast(Types::Backgrounds,
      {"@type"          => "getBackgrounds",
  ...
  # basic_group_id [::Int32] Basic group identifier.
  def get_basic_group(basic_group_id : ::Int32)
    broadcast(Types::BasicGroup,
      {"@type"          => "getBasicGroup",
       "basic_group_id" => basic_group_id
      })
  end
  ...
  # basic_group_id [::Int32] Basic group identifier.
  def get_basic_group_full_info(basic_group_id : ::Int32)
    broadcast(Types::BasicGroupFullInfo,
  ...
  def get_blocked_users(offset : ::Int32, limit : ::Int32)
    broadcast(Types::Users,
  ...
  def get_callback_query_answer(chat_id : ::Int64, message_id : ::Int64, payload : Proton::Types::CallbackQueryPayload)
    broadcast(Types::CallbackQueryAnswer,
  ...
  # chat_id [::Int64] Chat identifier.
  def get_chat_administrators(chat_id : ::Int64)
    broadcast(Types::Users,
  ...
  def get_chat_event_log(chat_id : ::Int64, query : ::String, from_event_id : ::String, limit : ::Int32, filters : Proton::Types::ChatEventLogFilters, user_ids : ::Array(::Int32))
    broadcast(Types::ChatEvents,
  ...
  def get_chat_history(chat_id : ::Int64, from_message_id : ::Int64, offset : ::Int32, limit : ::Int32, only_local : ::Bool)
    broadcast(Types::Messages,
      {"@type"           => "getChatHistory",
       "chat_id"         => chat_id,
  ...
  # chat_id [::Int64] Chat identifier.
  # user_id [::Int32] User identifier.
  def get_chat_member(chat_id : ::Int64, user_id : ::Int32)
    broadcast(Types::ChatMember,
      {"@type"   => "getChatMember",
       "chat_id" => chat_id,
       "user_id" => user_id
      })
  ...
  def get_chat_message_by_date(chat_id : ::Int64, date : ::Int32)
    broadcast(Types::Message,
  ...
  def get_chat_message_count(chat_id : ::Int64, filter : Proton::Types::SearchMessagesFilter, return_local : ::Bool)
    broadcast(Types::Count,
  ...
  def get_chat_notification_settings_exceptions(scope : Proton::Types::NotificationSettingsScope, compare_sound : ::Bool)
    broadcast(Types::Chats,
  ...
  def get_chat_pinned_message(chat_id : ::Int64)
    broadcast(Types::Message,
  ...
  # chat_id [::Int64] Chat identifier.
  def get_chat_report_spam_state(chat_id : ::Int64)
    broadcast(Types::ChatReportSpamState,
  ...
  def get_chat_statistics_url(chat_id : ::Int64, parameters : ::String, is_dark : ::Bool)
    broadcast(Types::HttpUrl,
  ...
  def get_chats(offset_order : ::String, offset_chat_id : ::Int64, limit : ::Int32)
    broadcast(Types::Chats,
      {"@type"          => "getChats",
  ...
  def get_connected_websites()
    broadcast(Types::ConnectedWebsites,
  ...
  def get_database_statistics()
    broadcast(Types::DatabaseStatistics,
  ...
  def get_deep_link_info(link : ::String)
    broadcast(Types::DeepLinkInfo,
  ...
  def get_emoji_suggestions_url(language_code : ::String)
    broadcast(Types::HttpUrl,
  ...
  def get_file_downloaded_prefix_size(file_id : ::Int32, offset : ::Int32)
    broadcast(Types::Count,
  ...
  def get_file_extension(mime_type : ::String)
    broadcast(Types::Text,
  ...
  def get_file_mime_type(file_name : ::String)
    broadcast(Types::Text,
  ...
  # message_id [::Int64] Identifier of the message.
  # user_id [::Int32] User identifier.
  def get_game_high_scores(chat_id : ::Int64, message_id : ::Int64, user_id : ::Int32)
    broadcast(Types::GameHighScores,
  ...
  def get_groups_in_common(user_id : ::Int32, offset_chat_id : ::Int64, limit : ::Int32)
    broadcast(Types::Chats,
  ...
  # inline_message_id [::String] Inline message identifier.
  # user_id [::Int32] User identifier.
  def get_inline_game_high_scores(inline_message_id : ::String, user_id : ::Int32)
    broadcast(Types::GameHighScores,
  ...
  def get_inline_query_results(bot_user_id : ::Int32, chat_id : ::Int64, user_location : Proton::Types::Location, query : ::String, offset : ::String)
    broadcast(Types::InlineQueryResults,
  ...
  def get_installed_sticker_sets(is_masks : ::Bool)
    broadcast(Types::StickerSets,
  ...
  def get_json_string(json_value : Proton::Types::JsonValue)
    broadcast(Types::Text,
      {"@type"      => "getJsonString",
  ...
  def get_json_value(json : ::String)
    broadcast(Types::JsonValue,
      {"@type" => "getJsonValue",
       "json"  => json
      })
  ...
  def get_language_pack_info(language_pack_id : ::String)
    broadcast(Types::LanguagePackInfo,
  ...
  def get_language_pack_string(language_pack_database_path : ::String, localization_target : ::String, language_pack_id : ::String, key : ::String)
    broadcast(Types::LanguagePackStringValue,
  ...
  #   strings.
  def get_language_pack_strings(language_pack_id : ::String, keys : ::Array(::String))
    broadcast(Types::LanguagePackStrings,
  ...
  def get_localization_target_info(only_local : ::Bool)
    broadcast(Types::LocalizationTargetInfo,
  ...
  def get_log_tag_verbosity_level(tag : ::String)
    broadcast(Types::LogVerbosityLevel,
  ...
  #   Use 0 if unknown.
  def get_map_thumbnail_file(location : Proton::Types::Location, zoom : ::Int32, width : ::Int32, height : ::Int32, scale : ::Int32, chat_id : ::Int64)
    broadcast(Types::File,
  ...
  def get_message(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::Message,
      {"@type"      => "getMessage",
       "chat_id"    => chat_id,
       "message_id" => message_id
  ...
  # message_id [::Int64] Identifier of the message.
  def get_message_link(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::HttpUrl,
      {"@type"      => "getMessageLink",
       "chat_id"    => chat_id,
       "message_id" => message_id
  ...
  def get_message_link_info(url : ::String)
    broadcast(Types::MessageLinkInfo,
  ...
  # chat_id [::Int64] Identifier of the chat the message belongs to.
  # message_id [::Int64] Identifier of the message to get.
  def get_message_locally(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::Message,
  ...
  def get_messages(chat_id : ::Int64, message_ids : ::Array(::Int64))
    broadcast(Types::Messages,
      {"@type"       => "getMessages",
       "chat_id"     => chat_id,
       "message_ids" => message_ids
  ...
  def get_network_statistics(only_current : ::Bool)
    broadcast(Types::NetworkStatistics,
  ...
  def get_option(name : ::String)
    broadcast(Types::OptionValue,
      {"@type" => "getOption",
       "name"  => name
      })
  end
  ...
  def get_passport_authorization_form(bot_user_id : ::Int32, scope : ::String, public_key : ::String, nonce : ::String)
    broadcast(Types::PassportAuthorizationForm,
  ...
  # password [::String] Password of the current user.
  def get_passport_authorization_form_available_elements(autorization_form_id : ::Int32, password : ::String)
    broadcast(Types::PassportElementsWithErrors,
  ...
  # password [::String] Password of the current user.
  def get_passport_element(type : Proton::Types::PassportElementType, password : ::String)
    broadcast(Types::PassportElement,
  ...
  def get_payment_form(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::PaymentForm,
      {"@type"      => "getPaymentForm",
       "chat_id"    => chat_id,
       "message_id" => message_id
      })
  ...
  # message_id [::Int64] Message identifier.
  def get_payment_receipt(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::PaymentReceipt,
  ...
  def get_preferred_country_language(country_code : ::String)
    broadcast(Types::Text,
  ...
  # Can be called before authorization.
  # proxy_id [::Int32] Proxy identifier.
  def get_proxy_link(proxy_id : ::Int32)
    broadcast(Types::Text,
      {"@type"    => "getProxyLink",
       "proxy_id" => proxy_id
      })
  ...
  def get_public_message_link(chat_id : ::Int64, message_id : ::Int64, for_album : ::Bool)
    broadcast(Types::PublicMessageLink,
  ...
  def get_push_receiver_id(payload : ::String)
    broadcast(Types::PushReceiverId,
  ...
  def get_recent_stickers(is_attached : ::Bool)
    broadcast(Types::Stickers,
  ...
  def get_recently_visited_t_me_urls(referrer : ::String)
    broadcast(Types::TMeUrls,
  ...
  def get_recovery_email_address(password : ::String)
    broadcast(Types::RecoveryEmailAddress,
  ...
  def get_remote_file(remote_file_id : ::String, file_type : Proton::Types::FileType)
    broadcast(Types::File,
      {"@type"          => "getRemoteFile",
  ...
  def get_replied_message(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::Message,
  ...
  #   information.
  def get_scope_notification_settings(scope : Proton::Types::NotificationSettingsScope)
    broadcast(Types::ScopeNotificationSettings,
  ...
  # This is an offline request.
  # secret_chat_id [::Int32] Secret chat identifier.
  def get_secret_chat(secret_chat_id : ::Int32)
    broadcast(Types::SecretChat,
      {"@type"          => "getSecretChat",
       "secret_chat_id" => secret_chat_id
      })
  end
  ...
  def get_sticker_emojis(sticker : Proton::Types::InputFile)
    broadcast(Types::Emojis,
  ...
  # set_id [::String] Identifier of the sticker set.
  def get_sticker_set(set_id : ::String)
    broadcast(Types::StickerSet,
      {"@type"  => "getStickerSet",
       "set_id" => set_id
      })
  ...
  def get_stickers(emoji : ::String, limit : ::Int32)
    broadcast(Types::Stickers,
      {"@type" => "getStickers",
       "emoji" => emoji,
       "limit" => limit
  ...
  def get_storage_statistics(chat_limit : ::Int32)
    broadcast(Types::StorageStatistics,
  ...
  def get_storage_statistics_fast()
    broadcast(Types::StorageStatisticsFast,
  ...
  # This is an offline request if the current user is not a bot.
  # supergroup_id [::Int32] Supergroup or channel identifier.
  def get_supergroup(supergroup_id : ::Int32)
    broadcast(Types::Supergroup,
      {"@type"         => "getSupergroup",
       "supergroup_id" => supergroup_id
      })
  end
  ...
  # supergroup_id [::Int32] Supergroup or channel identifier.
  def get_supergroup_full_info(supergroup_id : ::Int32)
    broadcast(Types::SupergroupFullInfo,
  ...
  def get_supergroup_members(supergroup_id : ::Int32, filter : Proton::Types::SupergroupMembersFilter, offset : ::Int32, limit : ::Int32)
    broadcast(Types::ChatMembers,
  ...
  def get_text_entities(text : ::String)
    broadcast(Types::TextEntities,
  ...
  def get_top_chats(category : Proton::Types::TopChatCategory, limit : ::Int32)
    broadcast(Types::Chats,
      {"@type"    => "getTopChats",
       "category" => category,
       "limit"    => limit
  ...
  # user_id [::Int32] User identifier.
  def get_user_full_info(user_id : ::Int32)
    broadcast(Types::UserFullInfo,
  ...
  def get_user_privacy_setting_rules(setting : Proton::Types::UserPrivacySetting)
    broadcast(Types::UserPrivacySettingRules,
  ...
  def get_user_profile_photos(user_id : ::Int32, offset : ::Int32, limit : ::Int32)
    broadcast(Types::UserProfilePhotos,
  ...
  def get_web_page_instant_view(url : ::String, force_full : ::Bool)
    broadcast(Types::WebPageInstantView,
  ...
  def get_web_page_preview(text : Proton::Types::FormattedText)
    broadcast(Types::WebPage,
  ...
  #   are not imported.
  def import_contacts(contacts : ::Array(Proton::Types::Contact))
    broadcast(Types::ImportedContacts,
      {"@type"    => "importContacts",
       "contacts" => contacts
      })
  ...
  #   "https://telegram.me/joinchat/", or "https://telegram.dog/joinchat/".
  def join_chat_by_invite_link(invite_link : ::String)
    broadcast(Types::Chat,
  ...
  def open_message_content(chat_id : ::Int64, message_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def optimize_storage(size : ::Int64, ttl : ::Int32, count : ::Int32, immunity_delay : ::Int32, file_types : ::Array(Proton::Types::FileType), chat_ids : ::Array(::Int64), exclude_chat_ids : ::Array(::Int64), chat_limit : ::Int32)
    broadcast(Types::StorageStatistics,
  ...
  def parse_text_entities(text : ::String, parse_mode : Proton::Types::TextParseMode)
    broadcast(Types::FormattedText,
  ...
  def pin_chat_message(chat_id : ::Int64, message_id : ::Int64, disable_notification : ::Bool)
    broadcast(Types::Ok,
      {"@type"                => "pinChatMessage",
       "chat_id"              => chat_id,
       "message_id"           => message_id,
  ...
  def ping_proxy(proxy_id : ::Int32)
    broadcast(Types::Seconds,
      {"@type"    => "pingProxy",
       "proxy_id" => proxy_id
      })
  end
  ...
  def process_push_notification(payload : ::String)
    broadcast(Types::Ok,
  ...
  # chat_id [::Int64] Chat identifier.
  def read_all_chat_mentions(chat_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def read_file_part(file_id : ::Int32, offset : ::Int32, count : ::Int32)
    broadcast(Types::FilePart,
      {"@type"   => "readFilePart",
       "file_id" => file_id,
       "offset"  => offset,
       "count"   => count
  ...
  def recover_authentication_password(recovery_code : ::String)
    broadcast(Types::Ok,
  ...
  # recovery_code [::String] Recovery code to check.
  def recover_password(recovery_code : ::String)
    broadcast(Types::PasswordState,
  ...
  def register_device(device_token : Proton::Types::DeviceToken, other_user_ids : ::Array(::Int32))
    broadcast(Types::PushReceiverId,
      {"@type"          => "registerDevice",
  ...
  def register_user(first_name : ::String, last_name : ::String)
    broadcast(Types::Ok,
      {"@type"      => "registerUser",
  ...
  def remove_background(background_id : ::String)
    broadcast(Types::Ok,
  ...
  def remove_contacts(user_ids : ::Array(::Int32))
    broadcast(Types::Ok,
      {"@type"    => "removeContacts",
       "user_ids" => user_ids
      })
  ...
  def remove_favorite_sticker(sticker : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def remove_notification(notification_group_id : ::Int32, notification_id : ::Int32)
    broadcast(Types::Ok,
  ...
  def remove_notification_group(notification_group_id : ::Int32, max_notification_id : ::Int32)
    broadcast(Types::Ok,
  ...
  # Can be called before authorization.
  # proxy_id [::Int32] Proxy identifier.
  def remove_proxy(proxy_id : ::Int32)
    broadcast(Types::Ok,
      {"@type"    => "removeProxy",
       "proxy_id" => proxy_id
      })
  ...
  def remove_recent_hashtag(hashtag : ::String)
    broadcast(Types::Ok,
  ...
  def remove_recent_sticker(is_attached : ::Bool, sticker : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def remove_recently_found_chat(chat_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def remove_saved_animation(animation : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def remove_sticker_from_set(sticker : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  # chat_id [::Int64] Chat identifier.
  def remove_top_chat(category : Proton::Types::TopChatCategory, chat_id : ::Int64)
    broadcast(Types::Ok,
      {"@type"    => "removeTopChat",
       "category" => category,
       "chat_id"  => chat_id
  ...
  def reorder_installed_sticker_sets(is_masks : ::Bool, sticker_set_ids : ::Array(::String))
    broadcast(Types::Ok,
  ...
  def report_chat(chat_id : ::Int64, reason : Proton::Types::ChatReportReason, message_ids : ::Array(::Int64))
    broadcast(Types::Ok,
      {"@type"       => "reportChat",
       "chat_id"     => chat_id,
       "reason"      => reason,
  ...
  def report_supergroup_spam(supergroup_id : ::Int32, user_id : ::Int32, message_ids : ::Array(::Int64))
    broadcast(Types::Ok,
  ...
  def request_password_recovery()
    broadcast(Types::EmailAddressAuthenticationCodeInfo,
  ...
  def resend_messages(chat_id : ::Int64, message_ids : ::Array(::Int64))
    broadcast(Types::Messages,
      {"@type"       => "resendMessages",
       "chat_id"     => chat_id,
       "message_ids" => message_ids
  ...
  def save_application_log_event(type : ::String, chat_id : ::Int64, data : Proton::Types::JsonValue)
    broadcast(Types::Ok,
  ...
  def search_background(name : ::String)
    broadcast(Types::Background,
  ...
  def search_call_messages(from_message_id : ::Int64, limit : ::Int32, only_missed : ::Bool)
    broadcast(Types::Messages,
  ...
  def search_chat_members(chat_id : ::Int64, query : ::String, limit : ::Int32, filter : Proton::Types::ChatMembersFilter)
    broadcast(Types::ChatMembers,
  ...
  def search_chat_messages(chat_id : ::Int64, query : ::String, sender_user_id : ::Int32, from_message_id : ::Int64, offset : ::Int32, limit : ::Int32, filter : Proton::Types::SearchMessagesFilter)
    broadcast(Types::Messages,
  ...
  def search_chat_recent_location_messages(chat_id : ::Int64, limit : ::Int32)
    broadcast(Types::Messages,
  ...
  def search_chats(query : ::String, limit : ::Int32)
    broadcast(Types::Chats,
      {"@type" => "searchChats",
       "query" => query,
       "limit" => limit
  ...
  # query [::String] Query to search for.
  # limit [::Int32] Maximum number of chats to be returned.
  def search_chats_on_server(query : ::String, limit : ::Int32)
    broadcast(Types::Chats,
  ...
  def search_contacts(limit : ::Int32, query : ::String? = nil)
    broadcast(Types::Users,
      {"@type" => "searchContacts",
       "limit" => limit,
       "query" => query
  ...
  def search_emojis(text : ::String, exact_match : ::Bool)
    broadcast(Types::Emojis,
      {"@type"       => "searchEmojis",
       "text"        => text,
  ...
  def search_hashtags(prefix : ::String, limit : ::Int32)
    broadcast(Types::Hashtags,
      {"@type"  => "searchHashtags",
       "prefix" => prefix,
       "limit"  => limit
      })
  ...
  # query [::String] Query to search for.
  # limit [::Int32] Maximum number of sticker sets to return.
  def search_installed_sticker_sets(is_masks : ::Bool, query : ::String, limit : ::Int32)
    broadcast(Types::StickerSets,
  ...
  #   Fewer messages may be returned than specified by the limit, even if the end of the message history has not been
  #   reached.
  def search_messages(query : ::String, offset_date : ::Int32, offset_chat_id : ::Int64, offset_message_id : ::Int64, limit : ::Int32)
    broadcast(Types::Messages,
      {"@type"             => "searchMessages",
       "query"             => query,
  ...
  def search_public_chat(username : ::String)
    broadcast(Types::Chat,
  ...
  # query [::String] Query to search for.
  def search_public_chats(query : ::String)
    broadcast(Types::Chats,
  ...
  def search_secret_messages(chat_id : ::Int64, query : ::String, from_search_id : ::String, limit : ::Int32, filter : Proton::Types::SearchMessagesFilter)
    broadcast(Types::FoundMessages,
  ...
  def search_sticker_set(name : ::String)
    broadcast(Types::StickerSet,
  ...
  # query [::String] Query to search for.
  def search_sticker_sets(query : ::String)
    broadcast(Types::StickerSets,
  ...
  # limit [::Int32] Maximum number of stickers to be returned.
  def search_stickers(emoji : ::String, limit : ::Int32)
    broadcast(Types::Stickers,
      {"@type" => "searchStickers",
       "emoji" => emoji,
       "limit" => limit
  ...
  def send_bot_start_message(bot_user_id : ::Int32, chat_id : ::Int64, parameter : ::String)
    broadcast(Types::Message,
  ...
  def send_call_debug_information(call_id : ::Int32, debug_information : ::String)
    broadcast(Types::Ok,
  ...
  #   user.
  def send_call_rating(call_id : ::Int32, rating : ::Int32, comment : ::String, problems : ::Array(Proton::Types::CallProblem))
    broadcast(Types::Ok,
      {"@type"    => "sendCallRating",
       "call_id"  => call_id,
       "rating"   => rating,
  ...
  def send_chat_action(chat_id : ::Int64, action : Proton::Types::ChatAction)
    broadcast(Types::Ok,
      {"@type"   => "sendChatAction",
       "chat_id" => chat_id,
       "action"  => action
  ...
  # chat_id [::Int64] Chat identifier.
  def send_chat_screenshot_taken_notification(chat_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def send_chat_set_ttl_message(chat_id : ::Int64, ttl : ::Int32)
    broadcast(Types::Message,
  ...
  def send_custom_request(method : ::String, parameters : ::String)
    broadcast(Types::CustomRequestResult,
  ...
  def send_email_address_verification_code(email_address : ::String)
    broadcast(Types::EmailAddressAuthenticationCodeInfo,
  ...
  def send_inline_query_result_message(chat_id : ::Int64, reply_to_message_id : ::Int64, disable_notification : ::Bool, from_background : ::Bool, query_id : ::String, result_id : ::String, hide_via_bot : ::Bool)
    broadcast(Types::Message,
  ...
  # reply_markup [Proton::Types::ReplyMarkup, nil] Markup for replying to the message; for bots only.
  def send_message(chat_id : ::Int64, reply_to_message_id : ::Int64, disable_notification : ::Bool, from_background : ::Bool, input_message_content : Proton::Types::InputMessageContent, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Message,
      {"@type"                 => "sendMessage",
       "chat_id"               => chat_id,
       "reply_to_message_id"   => reply_to_message_id,
  ...
  def send_message_album(chat_id : ::Int64, reply_to_message_id : ::Int64, disable_notification : ::Bool, from_background : ::Bool, input_message_contents : ::Array(Proton::Types::InputMessageContent))
    broadcast(Types::Messages,
  ...
  def send_passport_authorization_form(autorization_form_id : ::Int32, types : ::Array(Proton::Types::PassportElementType))
    broadcast(Types::Ok,
  ...
  def send_payment_form(chat_id : ::Int64, message_id : ::Int64, order_info_id : ::String, shipping_option_id : ::String, credentials : Proton::Types::InputCredentials)
    broadcast(Types::PaymentResult,
  ...
  # settings [Proton::Types::PhoneNumberAuthenticationSettings] Settings for the authentication of the user's phone
  #   number.
  def send_phone_number_confirmation_code(hash : ::String, phone_number : ::String, settings : Proton::Types::PhoneNumberAuthenticationSettings)
    broadcast(Types::AuthenticationCodeInfo,
  ...
  # settings [Proton::Types::PhoneNumberAuthenticationSettings] Settings for the authentication of the user's phone
  #   number.
  def send_phone_number_verification_code(phone_number : ::String, settings : Proton::Types::PhoneNumberAuthenticationSettings)
    broadcast(Types::AuthenticationCodeInfo,
  ...
  def set_account_ttl(ttl : Proton::Types::AccountTtl)
    broadcast(Types::Ok,
      {"@type" => "setAccountTtl",
       "ttl"   => ttl
      })
  ...
  def set_authentication_phone_number(phone_number : ::String, settings : Proton::Types::PhoneNumberAuthenticationSettings? = nil)
    broadcast(Types::Ok,
  ...
  def set_auto_download_settings(settings : Proton::Types::AutoDownloadSettings, type : Proton::Types::NetworkType)
    broadcast(Types::Ok,
  ...
  def set_background(background : Proton::Types::InputBackground, type : Proton::Types::BackgroundType, for_dark_theme : ::Bool)
    broadcast(Types::Background,
      {"@type"          => "setBackground",
  ...
  def set_bot_updates_status(pending_update_count : ::Int32, error_message : ::String)
    broadcast(Types::Ok,
  ...
  def set_chat_client_data(chat_id : ::Int64, client_data : ::String)
    broadcast(Types::Ok,
  ...
  def set_chat_description(chat_id : ::Int64, description : ::String)
    broadcast(Types::Ok,
  ...
  def set_chat_draft_message(chat_id : ::Int64, draft_message : Proton::Types::DraftMessage? = nil)
    broadcast(Types::Ok,
  ...
  def set_chat_member_status(chat_id : ::Int64, user_id : ::Int32, status : Proton::Types::ChatMemberStatus)
    broadcast(Types::Ok,
  ...
  def set_chat_notification_settings(chat_id : ::Int64, notification_settings : Proton::Types::ChatNotificationSettings)
    broadcast(Types::Ok,
  ...
  def set_chat_permissions(chat_id : ::Int64, permissions : Proton::Types::ChatPermissions)
    broadcast(Types::Ok,
  ...
  def set_chat_photo(chat_id : ::Int64, photo : Proton::Types::InputFile)
    broadcast(Types::Ok,
      {"@type"   => "setChatPhoto",
       "chat_id" => chat_id,
       "photo"   => photo
  ...
  def set_chat_title(chat_id : ::Int64, title : ::String)
    broadcast(Types::Ok,
      {"@type"   => "setChatTitle",
       "chat_id" => chat_id,
       "title"   => title
  ...
  def set_custom_language_pack(info : Proton::Types::LanguagePackInfo, strings : ::Array(::String))
    broadcast(Types::Ok,
  ...
  def set_custom_language_pack_string(language_pack_id : ::String, new_string : ::String)
    broadcast(Types::Ok,
  ...
  def set_database_encryption_key(new_encryption_key : ::String)
    broadcast(Types::Ok,
  ...
  def set_file_generation_progress(generation_id : ::String, expected_size : ::Int32, local_prefix_size : ::Int32)
    broadcast(Types::Ok,
  ...
  def set_game_score(chat_id : ::Int64, message_id : ::Int64, edit_message : ::Bool, user_id : ::Int32, score : ::Int32, force : ::Bool)
    broadcast(Types::Message,
      {"@type"        => "setGameScore",
       "chat_id"      => chat_id,
       "message_id"   => message_id,
  ...
  # force [::Bool] Pass true to update the score even if it decreases.
  #   If the score is 0, the user will be deleted from the high score table.
  def set_inline_game_score(inline_message_id : ::String, edit_message : ::Bool, user_id : ::Int32, score : ::Int32, force : ::Bool)
    broadcast(Types::Ok,
  ...
  def set_log_stream(log_stream : Proton::Types::LogStream)
    broadcast(Types::Ok,
      {"@type"      => "setLogStream",
  ...
  def set_log_tag_verbosity_level(tag : ::String, new_verbosity_level : ::Int32)
    broadcast(Types::Ok,
  ...
  def set_log_verbosity_level(new_verbosity_level : ::Int32)
    broadcast(Types::Ok,
  ...
  def set_name(first_name : ::String, last_name : ::String)
    broadcast(Types::Ok,
      {"@type"      => "setName",
       "first_name" => first_name,
       "last_name"  => last_name
  ...
  def set_network_type(type : Proton::Types::NetworkType)
    broadcast(Types::Ok,
      {"@type" => "setNetworkType",
       "type"  => type
      })
  ...
  def set_option(name : ::String, value : Proton::Types::OptionValue)
    broadcast(Types::Ok,
      {"@type" => "setOption",
       "name"  => name,
       "value" => value
  ...
  # password [::String] Password of the current user.
  def set_passport_element(element : Proton::Types::InputPassportElement, password : ::String)
    broadcast(Types::PassportElement,
  ...
  def set_passport_element_errors(user_id : ::Int32, errors : ::Array(Proton::Types::InputPassportElementError))
    broadcast(Types::Ok,
  ...
  def set_password(old_password : ::String, set_recovery_email_address : ::Bool, new_password : ::String? = nil, new_hint : ::String? = nil, new_recovery_email_address : ::String? = nil)
    broadcast(Types::PasswordState,
      {"@type"                      => "setPassword",
  ...
  def set_pinned_chats(chat_ids : ::Array(::Int64))
    broadcast(Types::Ok,
      {"@type"    => "setPinnedChats",
       "chat_ids" => chat_ids
      })
  ...
  def set_poll_answer(chat_id : ::Int64, message_id : ::Int64, option_ids : ::Array(::Int32))
    broadcast(Types::Ok,
      {"@type"      => "setPollAnswer",
       "chat_id"    => chat_id,
       "message_id" => message_id,
  ...
  def set_profile_photo(photo : Proton::Types::InputFile)
    broadcast(Types::Ok,
  ...
  def set_recovery_email_address(password : ::String, new_recovery_email_address : ::String)
    broadcast(Types::PasswordState,
  ...
  def set_scope_notification_settings(scope : Proton::Types::NotificationSettingsScope, notification_settings : Proton::Types::ScopeNotificationSettings)
    broadcast(Types::Ok,
  ...
  def set_sticker_position_in_set(sticker : Proton::Types::InputFile, position : ::Int32)
    broadcast(Types::Ok,
  ...
  def set_supergroup_sticker_set(supergroup_id : ::Int32, sticker_set_id : ::String)
    broadcast(Types::Ok,
  ...
  def set_supergroup_username(supergroup_id : ::Int32, username : ::String)
    broadcast(Types::Ok,
  ...
  def set_tdlib_parameters(parameters : Proton::Types::TdlibParameters)
    broadcast(Types::Ok,
  ...
  def set_user_privacy_setting_rules(setting : Proton::Types::UserPrivacySetting, rules : Proton::Types::UserPrivacySettingRules)
    broadcast(Types::Ok,
  ...
  # message_id [::Int64] Identifier of the message containing the poll.
  # reply_markup [Proton::Types::ReplyMarkup, nil] The new message reply markup; for bots only.
  def stop_poll(chat_id : ::Int64, message_id : ::Int64, reply_markup : Proton::Types::ReplyMarkup? = nil)
    broadcast(Types::Ok,
      {"@type"        => "stopPoll",
       "chat_id"      => chat_id,
       "message_id"   => message_id,
  ...
  # Can be called before authorization.
  # language_pack_id [::String] Language pack identifier.
  def synchronize_language_pack(language_pack_id : ::String)
    broadcast(Types::Ok,
  ...
  def terminate_session(session_id : ::String)
    broadcast(Types::Ok,
  ...
  def toggle_chat_default_disable_notification(chat_id : ::Int64, default_disable_notification : ::Bool)
    broadcast(Types::Ok,
  ...
  def toggle_chat_is_marked_as_unread(chat_id : ::Int64, is_marked_as_unread : ::Bool)
    broadcast(Types::Ok,
  ...
  def toggle_chat_is_pinned(chat_id : ::Int64, is_pinned : ::Bool)
    broadcast(Types::Ok,
  ...
  def toggle_supergroup_is_all_history_available(supergroup_id : ::Int32, is_all_history_available : ::Bool)
    broadcast(Types::Ok,
  ...
  def toggle_supergroup_sign_messages(supergroup_id : ::Int32, sign_messages : ::Bool)
    broadcast(Types::Ok,
  ...
  # chat_id [::Int64] Identifier of the chat.
  def unpin_chat_message(chat_id : ::Int64)
    broadcast(Types::Ok,
  ...
  def upgrade_basic_group_chat_to_supergroup_chat(chat_id : ::Int64)
    broadcast(Types::Chat,
  ...
  #   first.
  def upload_file(file : Proton::Types::InputFile, file_type : Proton::Types::FileType, priority : ::Int32)
    broadcast(Types::File,
      {"@type"     => "uploadFile",
       "file"      => file,
       "file_type" => file_type,
  ...
  #   square.
  def upload_sticker_file(user_id : ::Int32, png_sticker : Proton::Types::InputFile)
    broadcast(Types::File,
  ...
  def validate_order_info(chat_id : ::Int64, message_id : ::Int64, order_info : Proton::Types::OrderInfo, allow_save : ::Bool)
    broadcast(Types::ValidatedOrderInfo,
  ...
  def view_messages(chat_id : ::Int64, message_ids : ::Array(::Int64), force_read : ::Bool)
    broadcast(Types::Ok,
      {"@type"       => "viewMessages",
       "chat_id"     => chat_id,
       "message_ids" => message_ids,
  ...
  def view_trending_sticker_sets(sticker_set_ids : ::Array(::String))
    broadcast(Types::Ok,
  ...
  def write_generated_file_part(generation_id : ::String, offset : ::Int32, data : ::String)
    broadcast(Types::Ok,
