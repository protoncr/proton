...
module Proton::MTProto
  ...
  record Deserialization,
    ...
    rpc_results : Array(Tuple(Int64, Bytes | Error::RequestError)),
    # Updates that came in the response.
    updates : Array(Bytes)

  # The module used by the [Mobile Transport Protocol] to serialize outgoing
  ...
  module Mtp
    ...
    abstract def push(request : Bytes) : Int64?
