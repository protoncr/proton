...
module Proton::Types
  ...
  class Supergroup < Types::Base
    ...
    def initialize(@id : ::Int32, @date : ::Int32, @status : Proton::Types::ChatMemberStatus, @member_count : ::Int32, @restriction_reason : ::String, @username : ::String? = nil, @sign_messages : ::Bool = false, @is_channel : ::Bool = false, @is_verified : ::Bool = false, @is_scam : ::Bool = false)
    end
  end
end
