...
module Proton::Types
  ...
  class InputMessageContent::Forwarded < Types::InputMessageContent
    ...
    property in_game_share : ::Bool = false
    ...
    property send_copy : ::Bool = false

    # True, if media caption of the message copy needs to be removed. Ignored if send_copy is false
    property remove_caption : ::Bool = false

    def initialize(@from_chat_id : ::Int64, @message_id : ::Int64, @in_game_share : ::Bool = false, @send_copy : ::Bool = false, @remove_caption : ::Bool = false)
    end
  end
end
