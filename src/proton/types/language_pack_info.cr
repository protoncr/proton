...
module Proton::Types
  ...
  class LanguagePackInfo < Types::Base
    ...
    def initialize(@id : ::String, @name : ::String, @native_name : ::String, @plural_code : ::String, @total_string_count : ::Int32, @translated_string_count : ::Int32, @local_string_count : ::Int32, @base_language_pack_id : ::String? = nil, @is_official : ::Bool = false, @is_rtl : ::Bool = false, @is_beta : ::Bool = false, @is_installed : ::Bool = false, @translation_url : ::String? = nil)
    end
  end
end
