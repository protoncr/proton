...
module Proton::Types
  ...
  class Chat < Types::Base
    ...
    def initialize(@id : ::Int32, @reply_markup_message_id : ::Int32, @pinned_message_id : ::Int32, @notification_settings : Proton::Types::ChatNotificationSettings, @unread_mention_count : ::Int32, @last_read_outbox_message_id : ::Int32, @last_read_inbox_message_id : ::Int32, @unread_count : ::Int32, @default_disable_notification : ::Bool, @can_be_reported : ::Bool, @can_be_deleted_for_all_users : ::Bool, @can_be_deleted_only_for_self : ::Bool, @is_sponsored : ::Bool, @is_marked_as_unread : ::Bool, @is_pinned : ::Bool, @order : ::String, @permissions : Proton::Types::ChatPermissions, @title : ::String, @type : Proton::Types::ChatType, @client_data : ::String, @last_message : Proton::Types::Message? = nil, @photo : Proton::Types::ChatPhoto? = nil, @draft_message : Proton::Types::DraftMessage? = nil)
    end
  end
end
