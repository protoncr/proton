...
module Proton::Types
  ...
  class RemoteFile < Types::Base
    ...
    property is_uploading_active : ::Bool = false

    # True, if a remote copy is fully available
    property is_uploading_completed : ::Bool = false

    def initialize(@uploaded_size : ::Int32, @id : ::String? = nil, @is_uploading_active : ::Bool = false, @is_uploading_completed : ::Bool = false)
    end
  end
end
