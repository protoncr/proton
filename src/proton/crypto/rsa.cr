...
module Proton::Crypto
  module RSA
    record PublicKey, modulus : BigInt, exponent : UInt32
    ...
    PublicKeys = {
      ...
      # -----END RSA PUBLIC KEY-----
      -4344800451088585951 => PublicKey.new(
        BigInt.new(
      ...
      # JwIDAQAB
      # -----END PUBLIC KEY-----
      847625836280919973 => PublicKey.new(
        BigInt.new(
      ...
      # /wIDAQAB
      # -----END PUBLIC KEY-----
      1562291298945373506 => PublicKey.new(
        BigInt.new(
      ...
      # oQIDAQAB
      # -----END PUBLIC KEY-----
      -5859577972006586033 => PublicKey.new(
        BiInt.new(
      ...
      # AQIDAQAB
      # -----END PUBLIC KEY-----
      6491968696586960280 => PublicKey.new(
        BigInt.new(
      ...
      # -----END RSA PUBLIC KEY-----
      6427105915145367799 => PublicKey.new(
        BigInt.new(
      ...
      # -----END RSA PUBLIC KEY-----
      2685959930972952888 => PublicKey.new(
        BigInt.new(
    ...
    def self.encrypt(data : Slice | String, fingerprint)
      key = PublicKeys[fingerprint]?

      if !key
        raise "No key exists for fingerprint '#{fingerprint}'."
      end

      data = data.is_a?(String) ? data.to_slice : data
      big = BigInt.new data.hexstring, base: 16
      (big * key.exponent) % key.modulus
    end
  end
end
